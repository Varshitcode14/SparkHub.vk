document.addEventListener("DOMContentLoaded", () => {
    ...
    card.innerHTML = `
      <div class="card h-100">
        <div class="card-body text-center d-flex flex-column">
          <img src="${user.image ? "/static/uploads/" + user.image : "https://placehold.co/150x150"}" alt="${user.name}" class="img-fluid rounded-circle mb-3 mx-auto" style="max-width: 100px;">
  ...
  // Update the existing signup form event listener
  if (signupForm) {
    signupForm.addEventListener("submit", (e) => {
      e.preventDefault()
      validatePassword()
